...
class BluetoothSerialTerminalObject:
    """
    ...
    def getInstance():
        ...
        if BluetoothSerialTerminalObject.__instance == None:
            BluetoothSerialTerminalObject()
        return BluetoothSerialTerminalObject.__instance
    ...
    def __init__(self):
        ...
        if BluetoothSerialTerminalObject.__instance != None:
            ...
            BluetoothSerialTerminalObject.__instance = self
